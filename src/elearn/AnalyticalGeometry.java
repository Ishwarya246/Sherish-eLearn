 ...
 */
public class AnalyticalGeometry extends javax.swing.JFrame {

    /** Creates new form AnalyticalGeometry */
    public AnalyticalGeometry() {
        initComponents();
    }
    public String user;
    public AnalyticalGeometry(String user)
    {
        this.user = user;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ANALYTICAL GEOMETRY");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/analytical.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnalyticalGeometry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnalyticalGeometry().setVisible(true);
            }
        });
    }
